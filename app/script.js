...
const CHANGELOG = [
  { version: '1.1.8', notes: [
    'Fixed "self signed certificate" errors when sending invoices by email — added a Settings toggle for when antivirus/firewall software intercepts secure connections.'
  ] },
  { version: '1.1.7', notes: [
